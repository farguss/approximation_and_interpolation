...
def mnk(x,y,ax3,fig):
              ...
              plt.gcf().text(0.04, 0.45, 'MNK 1', fontsize=10)
              plt.gcf().text(0.04, 0.4, 'a = '+str(round(fp[0],4)), fontsize=10)
              plt.gcf().text(0.04, 0.35, 'b = '+str(round(fp[1],4)), fontsize=10)

              #plt.figtext(10,20,'Коэффициент -- a %s  '+ str(round(fp[0],4)))
              ...
              plt.gcf().text(0.04, 0.3, 'MNK 2', fontsize=10)
              plt.gcf().text(0.04, 0.25, 'a = '+str(round(fp[0],4)), fontsize=10)
              plt.gcf().text(0.04, 0.2, 'b = '+str(round(fp[1],4)), fontsize=10)
              plt.gcf().text(0.04, 0.15, 'c = '+str(round(fp[2],4)), fontsize=10)
...
def findy():
    ...
    y2 = fp[0] * float(entry2.get()) ** 2 + fp[1] * float(entry2.get()) + fp[2]
